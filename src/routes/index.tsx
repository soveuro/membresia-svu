    ...
    <>
      <div class="flex sm:flex-row flex-col h-screen w-full">
        ...
        <div class="sm:w-1/2 w-full h-1/2 sm:h-full bg-black flex flex-col justify-center items-center text-center">
          <a class="px-8 py-4 font-bold rounded w-2/3 mb-8 bg-[#ffff00] text-xl" href="/app/ingresar">
            <span >Ingresar</span>
          </a>
          <a class="px-8 py-4 font-bold rounded w-2/3 bg-[#ffff00] text-xl" href="/app/inscribir">
